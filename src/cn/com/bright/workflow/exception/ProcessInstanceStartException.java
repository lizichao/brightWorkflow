...
public class ProcessInstanceStartException extends RuntimeException {
     ...
     */
    public ProcessInstanceStartException() {
        super();
    }
     ...
     */
    public ProcessInstanceStartException(String msg) {
        super(msg);
    }
     ...
     * @since 1.5
     */
    public ProcessInstanceStartException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.5
     */
    public ProcessInstanceStartException(Throwable cause) {
        super(cause);
    }
}
