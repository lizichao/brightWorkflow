...
public class TaskDelegateException extends Exception {
     ...
     */
    public TaskDelegateException(String msg) {
        super(msg);
    }
     ...
     * @since 1.5
     */
    public TaskDelegateException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.5
     */
    public TaskDelegateException(Throwable cause) {
        super(cause);
    }
}
