...
public class NoApproveUsersException extends Exception {
     ...
     */
    public NoApproveUsersException() {
        super();
    }
     ...
     */
    public NoApproveUsersException(String msg) {
        super(msg);
    }
     ...
     * @since 1.5
     */
    public NoApproveUsersException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.5
     */
    public NoApproveUsersException(Throwable cause) {
        super(cause);
    }
}
