...
public class TaskNoExistException extends RuntimeException {
     ...
     */
    public TaskNoExistException(String msg) {
        super(msg);
    }
     ...
     * @since 1.5
     */
    public TaskNoExistException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.5
     */
    public TaskNoExistException(Throwable cause) {
        super(cause);
    }
}
