...
@Component
public class ReceiveFileSerialComponentListener implements IFunctionNotifyListener {
        ...
        if (componentName.equals("transfer")) {
            ...
            if (taskDefKey.equals("usertask7")) {
                ...
                ApplicationContextHelper.getManagementService()
                    .executeCommand(
                        new ReceiveFileTransferCmd(processInstanceId, currentUserId, transferUserId,taskDefKey));
            }
        }
    }
}
