...
@Component
public class ReceiveFileSerialEditCounterListener implements IEditCounterFunctionListener {

	public void notifyBeforeEvent(EditCounterSignVO editCounterSignVO)
			throws Exception {
		// TODO Auto-generated method stub
		
	}

	public void notifyAfterEvent(EditCounterSignVO editCounterSignVO)
			throws Exception {
	...
	private void deletePartDept(List<DepartmentVO> removeDepartmentVOs,
			String businessKey) {
