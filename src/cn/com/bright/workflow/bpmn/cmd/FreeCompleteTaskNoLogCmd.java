...
public class FreeCompleteTaskNoLogCmd extends FreeCompleteTaskCmd {
    private static final long serialVersionUID = 7186913306614262498L;

    public FreeCompleteTaskNoLogCmd(String taskId, String targetActivityId, Map<String, Object> variables,
