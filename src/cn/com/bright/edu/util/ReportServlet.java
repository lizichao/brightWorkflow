...
public class ReportServlet  extends javax.servlet.http.HttpServlet{
	...
	public void service(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
       ...
       ReportInterface reportInstance=null;
       try{
    	  if (StringUtil.isEmpty(className)){
    	      reportInstance = new BaseReport();
    	  }
    	  else{
    		  Class classObject = Class.forName("cn.com.bright.edu.report."+className);    		  
    		  reportInstance =  (ReportInterface) classObject.newInstance();
    	  }
          destFileName =   reportInstance.makeReport(parasMap); 
