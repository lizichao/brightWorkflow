...
<img src="/images/butstart.gif" alt="首页" align="absmiddle" border=0>
<img src="/images/butback.gif" alt="上页" align="absmiddle" border=0>
<img src="/images/butnext.gif" alt="下页" align="absmiddle" border=0>
<img src="/images/butend.gif" alt="末页" align="absmiddle" border=0>
</bc:if><bc:else>
<bc:if name='PageNo[text()="1"]'>
<img src="/images/butstart.gif" alt="首页" align="absmiddle" border=0>
<img src="/images/butback.gif" alt="上页" align="absmiddle" border=0>
<a href="#" onClick="javascript:next();"><img src="/images/butnext.gif" alt="下页" align="absmiddle" border=0></a>
<a href="#" onClick="javascript:last();"><img src="/images/butend.gif" alt="末页" align="absmiddle" border=0></a>
</bc:if><bc:else>
<bc:if name=".[PageNo=PageCount]">
<a href="#" onClick="javascript:first();"><img src="/images/butstart.gif" alt="首页" align="absmiddle" border=0></a>
<a href="#" onClick="javascript:prior();"><img src="/images/butback.gif" alt="上页" align="absmiddle" border=0></a>
<img src="/images/butnext.gif" alt="下页" align="absmiddle" border=0>
<img src="/images/butend.gif" alt="末页" align="absmiddle" border=0>
</bc:if><bc:else>
<a href="#" onClick="javascript:first();"><img src="/images/butstart.gif" alt="首页" align="absmiddle" border=0></a>
