Ext.namespace("jsp.masterreview.arealeader");jsp.masterreview.arealeader.arealeader=function(){var __caches__=[];this.__caches__=__caches__;var _editInfoWin; 
       function openEditInfoWin(_rec){ 
        ...
        }var ArealeaderRec=Ext.data.Record.create([  {
    xtype : "Field",
    name : "id",
    width : 150,
    fieldLabel : "主键id",
...
this.ArealeaderRec=ArealeaderRec;this.__caches__.push(ArealeaderRec);var ArealeaderStore=Ext.create({
  xtype : "Store",
  classname : "ArealeaderStore",
  type : "JrafXmlStore",
  recordType : ArealeaderRec,
  idProperty : "id",
  api : {
    read :     {
      sysName : "headmaster",
      oprID : "arealeaderAction",
      actions : "findArealeader"
  },
    create :     {
      sysName : "headmaster",
      oprID : "arealeaderAction",
      actions : "addArealeader"
  },
    update :     {
      sysName : "headmaster",
      oprID : "arealeaderAction",
      actions : "updateArealeader"
  },
    destroy :     {
      sysName : "headmaster",
      oprID : "arealeaderAction",
      actions : "deleteArealeader"
  }
},
  autoLoad : true,
  autoSave : false,
...
this.ArealeaderStore=ArealeaderStore;this.__caches__.push(ArealeaderStore);var EditInfoForm=Ext.create({
  xtype : "form",
  ...
  buttons : [    {
      ...
      handler : function() {
				...
				var jr;
			    if(newFlag){
		            jr=new JrafRequest('headmaster','arealeaderAction','addArealeader',{recordType:ArealeaderRec,idProperty:'id'});
		        }else{
		            jr=new JrafRequest('headmaster','arealeaderAction','updateArealeader',{recordType:ArealeaderRec,idProperty:'id'});
		        }
				jr.setForm(_form);
...
this.EditInfoForm=EditInfoForm;this.__caches__.push(EditInfoForm);var MainPanel=new Ext.Panel({layout:'fit',border:false,bodyBorder:false,items:[  {
    ...
    items : [      {
        ...
        buttonAlign : "center",
        id : "ArealeaderQryForm",
        buttons : [        {
          text : "查询",
          handler : function(){
            var qStore=Ext.getCmp('ArealeaderGrid').getStore();
            qStore.setFormParam(Ext.getCmp('ArealeaderQryForm'));
        ...
        autoHeight : false,
        height : 320,
        store : ArealeaderStore,
        bbar : new Ext.PagingToolbar({pageSize: JrafSession.get('PageSize'),store:ArealeaderStore,displayInfo: true}),
        ...
        {text:'删除',iconCls:'delete',ref: '../removeBtn',disabled: true,handler:function(){
					...
					var jr=new JrafRequest('headmaster','arealeaderAction','deleteArealeader');
			 		jr.setExtraPs(param);
