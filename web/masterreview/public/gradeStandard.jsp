...
<body >
		<div class="loadhd" style="margin-top: 16px;height: 10px;" >
		     <span class="close" onclick="windowclose();" style="float: right;margin-right: 10px;" >
		       <img style="cursor:pointer;" src="/images/close.png" alt="" />
		      </span>
		</div>
	
	<div class="container" style="width:700px;margin-left:10px;margin-right:10px;">
		<div class="xiao_bg" style="width:700px;height:330px;margin-top:16px">
			<div class="new-title"><b id="newsTitleId">评分标准说明</b>
			</div>
