...
function bulidManageDifficulty(masterReviewVO){
	...
	if(manageDifficultyAgoSelId){
		...
		attachmentArray.push("&nbsp;&nbsp;");
		attachmentArray.push("<a class=\"chachu\"  href=\"javascript:void(0);\" onclick=\"Headmaster.deleteReceiveFileAttachment(\'"+manageDifficultyAgoSelId+"\',this);\" >删除</a>");
...
<!-- Main Start -->
	...
	<div class="com-title">
		<div class="txt fl">
			<h2><i>11</i>管理难度</h2>
			<p>近8年无交流任职经历的，填写现任职学校；有交流任职经历的，填写现任职学校和近8年任职交流的管理难度最大的学校。</p>
		</div>
