<%@ page language="java" contentType="application/vnd.ms-excel; charset=iso8859-1" pageEncoding="iso8859-1"%>
...
<%
	...
	try{
		...
		response.addHeader("Content-Disposition", "attachment; filename=\"" + toUtf8(sb.toString()) +   ".jpg\"");
