...
function CleverTabs(self, options) {
    ...
    this.options = $.extend({
        ...
        //Tab用于显示的Panel模板
        tabPanelTemplate: '<div id="cleverTabPanelItem-#{id}" style="height: 100%;"><iframe frameborder=”0” border=”0″ marginwidth=”0″ marginheight=”0″ style="width: 100%; display: inline; height: 100%;" src="#{src}"></iframe></div>',
        //Tab唯一id生成器
...
CleverTabs.prototype.add = function (options) {
    ...
    if (self.panelContainer.attr('id').indexOf('cleverTabsPanelContainer') === 0) {
		...
		height = self.wrapper.height() - self.element.height();
		self.panelContainer.css('height', height+'px');
    }
...
CleverTabs.prototype.setupContextMenu = function () {
    ...
    if (!self.options.contextMenu) {
        ...
        + '<li id="mnuEnabl" ><a href="#enabled"><span class="ui-icon ui-icon-pencil" style="float: left; margin-right: 5px;"></span>激活</a></li>'
        + '<li id="mnuDisalb"><a href="#disable"><span class="ui-icon ui-icon-cancel" style="float: left; margin-right: 5px;"></span>失效</a></li>'
        ...
        + '<li id="mnuCloseAll"><a href="#clear"><span class="ui-icon ui-icon-closethick" style="float: left; margin-right: 5px;"></span>全部关闭</a></li>'
        + '</ul>'),
