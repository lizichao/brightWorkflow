...
$(document).ready(function(){
	...
	for(var i =0;i<toAddCounterNode.addCounterDepartments.length;i++){
		var eachToAddCounterNodeDepartment = toAddCounterNode.addCounterDepartments[i];
		//	resultDepartments.push(eachToAddCounterNodeDepartment);
			dataObject.Data.push(eachToAddCounterNodeDepartment)
	}
...
function getUncheckedDepartment(selectedMultiDepartments,deptId){
	for(var j =0;j<selectedMultiDepartments.length;j++){
		var eachSelectedMultiDepartmentId = selectedMultiDepartments[j].deptId;
		if(eachSelectedMultiDepartmentId == deptId){
			return false;
		}
	}
	return true;
