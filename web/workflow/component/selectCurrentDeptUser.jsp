...
<div id="userList" class="hi-table">
   ...
   <!--  
  <div class="hi-page"><a href="#" class="ico-sy">首页</a><a href="#" class="ico-syy">上一页</a>
    <div class="hi-num">第<input name="" type="text" value="1" />页  共8页</div>
      <a href="#" class="ico-xyy">下一页</a><a href="#" class="ico-wy">尾页</a> 
  </div>
-->
</div>
</div>
