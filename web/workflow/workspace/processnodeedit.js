Ext.namespace("jsp.workflow.workspace");jsp.workflow.workspace.processnodeedit=function(){var __caches__=[];this.__caches__=__caches__;var ProcessDefEditRec=Ext.data.Record.create([  {
    xtype : "Field",
    name : "nodeId",
    width : 150,
    fieldLabel : "节点Id",
...
this.ProcessDefEditRec=ProcessDefEditRec;this.__caches__.push(ProcessDefEditRec);var ProcessDefEditStore=Ext.create({
  xtype : "Store",
...
this.ProcessDefEditStore=ProcessDefEditStore;this.__caches__.push(ProcessDefEditStore);var EditInfoForm=Ext.create({
  xtype : "panel",
...
this.MainPanel=MainPanel;var __jrafonload=function(_params_){var qryIdentityNo = JrafUTIL.getParam(arguments[0],'identityno');
