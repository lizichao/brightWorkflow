Ext.namespace("jsp.workflow.workspace");jsp.workflow.workspace.processmonitorback=function(){var __caches__=[];this.__caches__=__caches__;
   ...
   function viewRender(value, meta, rec, rowIdx, colIdx, ds){
    ...
    var ProcessMonitorRec=Ext.data.Record.create([  {
    xtype : "Field",
