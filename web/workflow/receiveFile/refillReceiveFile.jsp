...
/*	var gatewayObject =Brightcom.workflow.flowInfos[gatewayFlowId];
	...
	var gatewayObject =Brightcom.workflow.flowInfos[gatewayFlowId];
	openReceiveDialog(gatewayObject.dest,gatewayFlowId,currentTaskKey);
	/*
	var paramObject = {
			"isCondition":gatewayFlowId,
...
function bulidReceiveView(receiveFileVO){
	...
	var startApprove =  approveLogs["startEvent"];//发起流程 办公室拟办意见
	var curatorApprove =  approveLogs["usertask6"];//馆领导批示
	var deptMultiApprove =  approveLogs["usertask7"];//部门办理意见
	
	$("#startLog").html(bulidApproveStr(startApprove));
	$("#curatorLog").html(bulidApproveStr(curatorApprove));
	$("#deptMultiLog").html(bulidApproveStr(deptMultiApprove));
...
function bulidApproveStr(approveLogs){
	if(!approveLogs){
		return "";
	}
	var approveArray = [];
...
<table border="0" cellspacing="0" cellpadding="0" class="table3" >
	  ...
	  <tr >
	   ...
	   <tr>
	     <td >发出日期</td>
		 <td width="65">
		    <label id="leaveDate" name="leaveDate"></label> 
		 </td>
		  <td width="65">
		   <label id="leaveDate" name="leaveDate"></label> 
		 </td>
	    ...
	    <tr>
	     <td >姓名/单位</td>
		 <td >
		    <label id="nameCompany" name="nameCompany"></label> 
		 </td>
		 <td >
		    <label id="nameCompany" name="nameCompany"></label> 
		 </td>
	    ...
	    <tr>
	     <td >办理类型</td>
		 <td >
		    <label id="manageType" name="manageType"></label> 
		 </td>
		  <td >
		    <label id="manageType" name="manageType"></label> 
		 </td>
	  ...
	  <tr style="height:110px">
	   ...
	   <tr style="height:110px">
		<td >馆领导批示</td>
		<td colspan="8">
		    <label id="curatorLog" name="deptLog"></label> 
		</td>
	  </tr>
	  <tr style="height:110px">
		<td >部门办理意见</td>
